    ...
    <div className="flex min-h-screen flex-col">
      <header className="sticky top-0 z-10 flex h-16 items-center justify-between border-b border-[var(--border)] bg-[var(--surface-card)] px-4 md:px-6">
        <div className="flex items-center gap-4">
          <div>
            <h1 className="text-lg font-semibold text-[var(--foreground)]">AI Insights</h1>
            <p className="text-sm text-[var(--muted-foreground)]">Smart observations about your recovery</p>
          </div>
        </div>
