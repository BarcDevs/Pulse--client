    ...
    return (
        <div className={'rounded-2xl bg-surface-card p-6'}>
            ...
            <div className={'space-y-6'}>
                <SettingToggle
                    label={SettingsTexts.SETTINGS_NOTIFICATIONS_DAILY_REMINDER_LABEL}
                    description={
                        SettingsTexts.SETTINGS_NOTIFICATIONS_DAILY_REMINDER_DESCRIPTION
                    }
                ...
                <SettingToggle
                    label={SettingsTexts.SETTINGS_NOTIFICATIONS_COMMUNITY_ALERTS_LABEL}
                    description={
                        SettingsTexts.SETTINGS_NOTIFICATIONS_COMMUNITY_ALERTS_DESCRIPTION
                    }
