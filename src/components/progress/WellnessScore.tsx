...
export const WellnessScore = () => (
  <div className={'rounded-2xl bg-surface-card p-6'}>
    ...
    <div className={'grid grid-cols-2 gap-4'}>
      <div>
        <p className={'text-xs text-muted-foreground uppercase'}>{PROGRESS_WELLNESS_MOOD}</p>
      ...
      <div>
        <p className={'text-xs text-muted-foreground uppercase'}>{PROGRESS_WELLNESS_PAIN}</p>
        <div className={'flex items-baseline gap-1 mt-1'}>
