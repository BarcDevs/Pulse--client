...
export const RecoveryInsight = () => (
    <div className={'rounded-2xl bg-linear-to-r from-primary-gradient-start to-primary-gradient-end p-6 text-primary-foreground'}>
        <div className={'flex items-start justify-between'}>
            ...
            {ProgressTexts.PROGRESS_RECOVERY_INSIGHT_LABEL}
        </span>
            </div>
            <Button
                variant={'ghost'}
        ...
        <h3 className={'mt-4 text-xl font-semibold'}>
            {ProgressTexts.PROGRESS_RECOVERY_INSIGHT_TITLE}
        </h3>

        <p className={'mt-3 text-primary-foreground/80 text-sm leading-relaxed'}>
            {ProgressTexts.PROGRESS_RECOVERY_INSIGHT_DESCRIPTION}
        </p>
        ...
        <div className={'mt-6 flex items-center gap-3'}>
            ...
            >
                {ProgressTexts.PROGRESS_RECOVERY_INSIGHT_KEEP}
            </Button>
            <Button
                variant={'ghost'}
                className={'text-primary-foreground hover:bg-white/10'}
            >
                {ProgressTexts.PROGRESS_RECOVERY_INSIGHT_ACKNOWLEDGE}
            </Button>
        </div>
    </div>
)
