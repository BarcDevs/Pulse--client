export const landing = {
    brandName: 'HealEase',
    descriptions: {
        about: `HealEase helps patients transitioning from hospital and clinical care get structured support for their recovery. Daily check-ins help you track progress, AI-powered insights provide guidance, and the community forum connects you with others who understand the journey. Recovery is simpler, and lonelier, when you're doing it alone. HealEase makes it practical.`,
