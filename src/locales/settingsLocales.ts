export const settingsLocales = {
    ...
    support: {
        ...
        helpCenter: 'settings.support.helpCenter'
    },
    buttons: {
        discardChanges: 'settings.buttons.discardChanges',
        savePreferences: 'settings.buttons.savePreferences',
        savingPreferences: 'settings.buttons.savingPreferences'
    },
    notifications: {
    ...
    privacy: {
        ...
        visibility: {
            ...
            options: 'settings.privacy.visibility.options'
        },
        dataSharing: {
    ...
    preferences: {
        ...
        theme: {
            title: 'settings.preferences.theme.title',
            description: 'settings.preferences.theme.description',
            light: 'settings.preferences.theme.light',
            dark: 'settings.preferences.theme.dark'
        },
        language: {
